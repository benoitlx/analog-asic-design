...
N 70 -30 120 -30 {lab=0}
N -30 40 -30 60 {lab=0}
N -30 -30 -30 -20 {lab=#net1}
N -30 -30 30 -30 {lab=#net1}
N 200 20 200 40 {lab=0}
N 200 -70 200 -40 {lab=#net2}
N 70 -70 70 -60 {lab=#net3}
N 200 -90 200 -70 {lab=#net2}
N 170 -90 200 -90 {lab=#net2}
N 70 -90 110 -90 {lab=#net3}
N 70 -90 70 -70 {lab=#net3}
...
C {gnd.sym} 120 40 0 0 {name=l2 lab=0}
C {gnd.sym} -30 60 0 0 {name=l3 lab=0}
C {vsource.sym} 200 -10 0 0 {name=VDS value=3 savecurrent=false}
C {gnd.sym} 200 40 0 0 {name=l4 lab=0}
